...
with graph.as_default():
  ...
  regularization_2 = beta * tf.nn.l2_loss(weights_2)
  ...
  loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits, tf_train_labels) + regularization_1 + regularization_2)
